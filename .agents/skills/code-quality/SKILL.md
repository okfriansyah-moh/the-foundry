---
name: code-quality
description: "Keep every task's implementation inside its complexity budget — correct, minimal, and maintainable, not merely"
---

<!-- ars:source .ai/skills/code-quality/SKILL.md -->
# Purpose
