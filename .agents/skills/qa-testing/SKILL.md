---
name: qa-testing
description: "Testing discipline for a system whose entire value proposition is \"evidence-based completion; no self-reported"
---

<!-- ars:source .ai/skills/qa-testing/SKILL.md -->
# Purpose
