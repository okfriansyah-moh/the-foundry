---
name: code-review
description: "A general, multi-pillar review pass usable on any diff in this repo — broader than `task-review` (which is"
---

<!-- ars:source .ai/skills/code-review/SKILL.md -->
# Purpose
