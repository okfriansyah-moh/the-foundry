...
description: "Frontend implementation discipline for the venture product template (Task 46+) — SvelteKit front, Go API back,"
---

<!-- ars:source .ai/skills/frontend-development/SKILL.md -->
# Purpose
