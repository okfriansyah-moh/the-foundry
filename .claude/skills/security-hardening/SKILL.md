...
description: "Apply application-security baseline (OWASP Top 10) to every task that touches `internal/*`, migrations, adapters,"
---

<!-- ars:source .ai/skills/security-hardening/SKILL.md -->
# Purpose
